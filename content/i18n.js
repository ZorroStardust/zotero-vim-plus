...
const ZV_I18N = {
  en: {
    ...
    "zv.scroll":            "Scroll",
    "zv.scroll.help":       "Tune both classic step scrolling and hold-based smooth scrolling behavior.",
    "zv.scroll.step":       "Scroll step (pixels)",
    "zv.scroll.smooth":     "Enable smooth scrolling for reader navigation (default)",
  ...
  "zh-CN": {
    ...
    "zv.scroll":            "滚动",
    "zv.scroll.help":       "调节经典步进滚动与按住式平滑滚动行为。",
    "zv.scroll.step":       "滚动步长（像素）",
    "zv.scroll.smooth":     "为阅读器导航启用平滑滚动（默认）",
